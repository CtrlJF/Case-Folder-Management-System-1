...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Retrieve form data
    $userId = $_POST['userIdRem'];
    $docType = $_POST['docTypeRem'];
    $docId = $_POST['docIdRem'];
    $remarks = $_POST['msg'];
    ...
    // Update document remarks in the specified table
    try {
        $sql = "UPDATE $table SET remarks = :remarks WHERE acc_id = :userId AND id = :id";
        ...
        echo "<script>alert('Remarks Added Successfully.');
        window.location='../../pendingDocs.php';</script>";
