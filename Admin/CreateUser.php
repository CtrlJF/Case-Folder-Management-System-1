...
<body>
    ...
    <div class="dashboard-main-wrapper">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title"> Create User Account </h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <!-- <li class="breadcrumb-item"><a href="#" class="btn btn-primary">create</a></li>
                                            <li class="breadcrumb-item"><a href="#" class="btn btn-success">import</a></li> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <form action="server/create/user_create.php" method="post">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-form-label text-dark" for="hhid">HHID</label>
                                                            <input class="form-control form-control-lg" type="text" pattern="\d{9}-\d{4}-\d{5}" title="Please enter a valid HHID" id="hhid" name="hhid" required placeholder="HouseHold ID" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-form-label text-dark" for="number">Phone Number</label>
                                                            <input class="form-control form-control-lg" type="text" id="number" name="number" placeholder="Phone number">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-form-label text-dark" for="barangay">Barangay</label>
                                                            <input class="form-control form-control-lg" type="text" id="barangay" name="barangay" required placeholder="Barangay">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-form-label text-dark" for="purok">Purok</label>
                                                            <input class="form-control form-control-lg" type="text" id="purok" name="purok" required placeholder="Purok">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-form-label text-dark" for="set">Set</label>
                                                            <input class="form-control form-control-lg" type="text" id="set" name="set" required placeholder="Set">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-form-label text-dark" for="phid">Phylsis ID number</label>
                                                            <input class="form-control form-control-lg" type="text" id="phid" name="phid" placeholder="Phylsis ID number" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-form-label text-dark" for="dpassword">Default Password</label>
                                                            <input class="form-control form-control-lg" name="dpassword" id="dpassword" type="text" placeholder="Create Default Password">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="server/create/users_create.php" enctype="multipart/form-data" method="POST">
                                            <div class="form-group">
                                                <label for="fileInput">Select Spreadsheet File:</label>
                                                <input type="file" class="form-control-file" id="fileInput" name="file" required>
                                            </div>
                                            <button type="submit" class="btn btn-primary">Import File</button>
                                        </form>
                                        <button class="btn btn-secondary mt-2" data-toggle='modal' data-target='#notes'><i class="fas fa-tags text-white"></i></button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="notes" tabindex="-1" role="dialog" aria-labelledby="idFormLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="idFormLabel">Important Notes</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p>Please ensure your spreadsheet follows the structure below for successful account creation:</p>
                        <ul class="text-left">
                            <li>**HHID:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;18 numeric digits only</li>
                            <li>**Password:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;create default password</li>
                            <li>**First Name:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Required</li>
                            <li>**Middle Name:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Not Required</li>
                            <li>**Last Name:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Required</li>
                            <li>**Phone Number:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Required</li>
                            <li>**Barangay:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Required</li>
                            <li>**Purok:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Required</li>
                            <li>**Set:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Required</li>
                            <li>**Phylsis ID:**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Required</li>
                        </ul>
                        <div class="text-right"> 
                            <button type="button" class="btn btn-primary" data-dismiss="modal">Okay</button>
                        </div>
