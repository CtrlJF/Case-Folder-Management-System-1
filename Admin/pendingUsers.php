...
require_once 'server/display/penuser_display.php';
?>
<!doctype html>
<html lang="en">
    ...
    <div class="dashboard-main-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="pendingUsers.php">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title"> Pending User Accounts </h2>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header bg-dark ">
                                        <h5 class="mb-0 " style="color: aliceblue;">User Accounts</h5>
                                        <p>Pending User Accounts</p>
                                    </div>
                                    <div class="card-body">
                                                        ...
                                                        <table id="example" class="table table-striped table-bordered second dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                                            ...
                                                            <?php foreach ($data as $row): ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo formatHhid(htmlspecialchars($row['hhid'])); ?></td>
                                                                    <td><?php echo htmlspecialchars($row['phone_number']); ?></td>
                                                                    <td><?php echo htmlspecialchars($row['barangay']); ?></td>
                                                                    <td><?php echo htmlspecialchars($row['purok']); ?></td>
                                                                    <td><?php echo htmlspecialchars($row['user_set']); ?></td>
                                                                    <td class="d-flex justify-content-around">
                                                                        <button class="btn btn-primary" data-toggle='modal' data-target='#appForm' data-user-name="<?php echo htmlspecialchars($row['fname'] . ' ' . $row['mname'] . ' ' . $row['lname']); ?>" data-user-id="<?php echo htmlspecialchars($row['acc_id']); ?>">Approved</button>
                                                                        <button class="btn btn-danger" data-toggle='modal' data-target='#delForm' data-user-name="<?php echo htmlspecialchars($row['fname'] . ' ' . $row['mname'] . ' ' . $row['lname']); ?>" data-user-id="<?php echo htmlspecialchars($row['acc_id']); ?>">Reject</button>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                            </tbody>
        ...
        <div class="modal fade" id="appForm" tabindex="-1" role="dialog" aria-labelledby="idFormLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="idFormLabel">Account Approval</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="server/update/appacc_update.php" method="post">
                        <div class="modal-body text-center">
                            <div class="form-group">
                                <p>Confirm approval for the account of <span id="userName" class="text-danger"></span>?</p>
        ...
        <div class="modal fade" id="delForm" tabindex="-1" role="dialog" aria-labelledby="idFormLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="idFormLabel">Account Rejection</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="server/update/rejacc_update.php" method="post">
                        <div class="modal-body text-center">
                            <div class="form-group">
                                <p>Confirm rejection for the account of <span id="userNameDel" class="text-danger"></span>?</p>
                                <input type="hidden" id="userIdDel" name="userIdDel" value="">                               
                            </div>
                        </div>
                        <div class="modal-footer d-flex justify-content-around pt-2 pb-2">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#delForm').on('show.bs.modal', function(event) {
                ...
                var userName = button.data('user-name');
                // Update the userIdInput value
                $('#userIdDel').val(userId);
                $('#userNameDel').text(userName);
            });
