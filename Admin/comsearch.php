...
require_once 'server/display/comsearch_display.php';
?>
<!doctype html>
<html lang="en">
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget no-print" >
                        ...
                        <div class="row content " id="completedTable">
                            <!-- start user completed search  -->
                            <!-- ============================================================== -->
                                ...
                                <div class="card">
                                    <div class="card-header bg-success d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <p class="text-light">This table shows the list of all 4P's Beneficiary exited and partial completed</p>
                                        </div>
                                        <div class="dropdown d-flex">
                                            <a class="btn btn-light mr-3" href='print_comsearch.php?barangay=<?php echo urlencode($barangay); ?>' target="_blank"><i class="fas fa-print text-dark"> Print</i></a>
                                            <input id="<?php echo $searchId; ?>" class="form-control w-150" name="search" type="text" placeholder="Search Name or HHID">
                                        </div>
                                    </div>
                                    <div class="card-body">
                                                        ...
                                                        <table id="example" class="table table-striped table-bordered second dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                                            <thead>
                                                                <tr role="row">
                                                                    ...
                                                                    <th style="width: 20px;">HHID</th>
                                                                    <th style="width: 20px;">Number</th>
                                                                    <th style="width: 34px;">Set</th>
                                                                    <th style="width: 34px;">Purok</th>
                                                                    <th style="width: 20px;">Date Entered</th>
                                                                    <th style="width: 80px;">Phylsis ID</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                            <?php foreach ($users as $user): 
                                                                $dateEntered = new DateTime($user['dateEntered']);
                                                                $formattedDate = $dateEntered->format('M d, Y');
                                                            ?>
                                                             <tr role="row" class="odd" data-status="<?php echo $isComplete === 'completed' ? 'completed' : 'active'; ?>">
                                                                <td><?php echo htmlspecialchars($user['fname'] . ' ' . $user['mname'] . ' ' . $user['lname']); ?></td>
