...
if(isset($_SESSION['acc_id'])) {
    ...
    $sql = "SELECT * FROM user_referral_letters WHERE acc_id = :acc_id ORDER BY id";
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Referral Letters</h2>
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                if (!empty($row['img'])) {
                                                    ...
                                                    if ($extension == 'pdf') {
                                                        ...
                                                        echo "<img src='../uploads/rl/{$row['img']}' alt='img' class='cover-image'>";
                                                    }
                                                } else {
