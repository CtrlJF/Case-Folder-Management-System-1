...
require_once 'server/displays/birthcert_display.php';
...
<head>
    ...
    <script src="functions/birthcert.js"></script>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title"> Birth Certificate</h2>
                                    ...
                                    <?php
                                        if ($stmt->rowCount() > 0) {
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                if (!empty($row['img'])) {
                                                    $filePath = '../uploads/birthcert/' . $row['img'];
                                                    ...
                                                    if ($extension == 'pdf') {
                                                        ...
                                                        echo "<img src='../uploads/birthcert/{$row['img']}' alt='img' class='cover-image'>";
                                                    }
                                                } else {
                                                ...
                                                echo "<input id='file-input-{$row['id']}' type='file' style='display: none;' accept='image/jpeg,image/png,application/pdf' data-user-birth-cert='{$row['id']}' onchange='handleFileSelect(event)'>";      
                                                

                                                if (!empty($row['img']) && file_exists("../uploads/birthcert/{$row['img']}")) {
                                                    echo "<a href='#' class='btn btn-info mr-2 printButton' data-img-src='../uploads/birthcert/{$row['img']}'> Print </a>";
                                                } else {
                                                ...
                                                echo "<button type='button' class='btn btn-danger delButton' data-toggle='modal' data-target='#delForm' data-user-birth-cert='{$row['id']}'>Delete</button>";
                                                echo "</div>";
                                                ...
                                                echo "<a href='#' data-toggle='modal' data-target='#remarks' data-type='Birth_Certificate' data-row-id='{$row['id']}'>Remarks</a>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="server/create/birthcert_create.php" method="post">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <form action="server/delete/birthcert_delete.php" method="post">
                            <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $('#delForm').on('show.bs.modal', function(event) {
            ...
            var userId = button.data('user-birth-cert'); // Extract info from data-* attributes
            console.log(userId);
