...
require_once 'server/displays/natioID_display.php';
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">National ID</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <!-- <li id="new-container" class="breadcrumb-item"><a href="#" class="btn btn-success"><i class="fas fa-plus"></i> New</a></li> -->
                                            <li id="new-container" class="breadcrumb-item">
                                    ...
                                    <?php
                                        if ($stmt->rowCount() > 0) {
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                if (!empty($row['img'])) {
                                                    $filePath = '../uploads/nationalID/' . $row['img'];
                                                    ...
                                                    if ($extension == 'pdf') {
                                                        ...
                                                        echo "<img src='../uploads/nationalID/{$row['img']}' alt='img' class='cover-image'>";
                                                    }
                                                } else {
                                                ...
                                                echo "<div class='product-price text-warning'>" . $row['famrole'] . "</div>";
                                                echo "<div class='product-price text-primary mt-1'>" . date('Y', strtotime($row['upload'])) . "</div>";
                                                echo "</div>";
                                                echo "<div class='product-content-head'>";
                                                echo "<a href='#' class='btn btn-primary mr-2' onclick=\"document.getElementById('file-input-{$row['id']}').click(); return false;\">Upload</a>";
                                                echo "<input id='file-input-{$row['id']}' type='file' style='display: none;' accept='image/jpeg,image/png,application/pdf' data-user-national-id='{$row['id']}' onchange='handleFileSelect(event)'>";      
                                                

                                                if (!empty($row['img']) && file_exists("../uploads/nationalID/{$row['img']}")) {
                                                    echo "<a href='#' class='btn btn-info mr-2 printButton' data-img-src='../uploads/nationalID/{$row['img']}'> Print </a>";
                                                } else {
                                                ...
                                                echo "<button type='button' class='btn btn-danger delButton' data-toggle='modal' data-target='#delForm' data-user-national-id='{$row['id']}'>Delete</button>";
                                                echo "</div>";
                                                ...
                                                echo "<a href='#' data-toggle='modal' data-target='#remarks' data-type='National_ID' data-row-id='{$row['id']}'>Remarks</a>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="server/create/natioID_modal.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="family-role" class="form-control" list="datalist" required>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <form action="server/delete/natioID_delete.php" method="post">
                            <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $('#delForm').on('show.bs.modal', function(event) {
            ...
            var userId = button.data('user-national-id'); // Extract info from data-* attributes
            console.log(userId);
